...
function $ (o) {
  ...
  if (t == 'string') {
    ...
    var options = 0
    //if (o.global) options |= $. ???
    if (o.ignoreCase) options |= $.NSRegularExpressionCaseInsensitive
    if (o.multiline) options |= $.NSRegularExpressionAnchorsMatchLines
    // TODO: add NSError support here
    var err = null
    return $.NSRegularExpression(
        'regularExpressionWithPattern', $(o.source),
        'options', options,
        'error', err)
  }
