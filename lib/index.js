...
$.global = _global
function _global () {
  require('./global').setGlobal(global)
  global.resolve = Import.resolve
  global.import = Import.import
  global.importFramework = Import.import
  return module.exports = global
}
