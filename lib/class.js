...
var exception = require('./exception').wrap;
var classCache = {};
...
Class.prototype.extend = function(className, _extraBytes) {
  ...
  var c = core.objc_allocateClassPair(this.classPointer, className, extraBytes);
  if (ref.isNull(c)) {
 ...
 * if necessary.
 */
Class.prototype.msgSend = function(args, supre, _parentFn) {
  var struct = [];
  ...
  if (supre) {
    args[0] = new objc_super({
      ...
      class: core.class_getSuperclass(this.pointer)
    }).ref();
    types[1][0] = '?';
...
Class.prototype.getName = function() {
  return core.class_getName(this.classPointer);
};

Class.prototype.isMetaClass = function() {
  return core.class_isMetaClass(this.classPointer);
};

Class.prototype.getInstanceSize = function() {
  return core.class_getInstanceSize(this.classPointer);
};

Class.prototype.getIvarLayout = function() {
  return core.class_getIvarLayout(this.classPointer);
};

Class.prototype.getVersion = function() {
  return core.class_getVersion(this.classPointer);
};

Class.prototype.setVersion = function(v) {
  return core.class_setVersion(this.classPointer, v);
};

Class.prototype.setSuperclass = function(superclass) {
  return core.wrapValue(core.class_setSuperclass(this.classPointer, superclass.pointer), '#');
};
...
Class.prototype.getClass = function() {
  ...
  console.assert(!ref.isNull(rtn), 'ID.getClass had empty pointer', rtn, rtn.address());
