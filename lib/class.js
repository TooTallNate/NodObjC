module.exports = (function() {
 ...
 /**
  ...
  Class.prototype.msgSend = function(args, supre, _parentFn) {
    var struct = []
      , args = [this, parseArgs(args, struct)].concat(struct)
      , sel = args[1]
      , types = this.getTypes(args[1], args.slice(2))
      , funcptr = core.objc_msgSend
      , parentFn = arguments.length >= 3 ? _parentFn : this.msgSend;
  ...
  Class.prototype.isMetaClass = function() { return core.class_isMetaClass(this.classPointer) != 0; }
