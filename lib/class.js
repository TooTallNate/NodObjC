module.exports = (function() { 
  ...
  Class.prototype.msgSend = function(sel, args, supre) {
    ...
    var msgSendFunc = supre ? ( structRaw ? core.get_objc_msgSendSuper_stret(msgtypes) 
                                          : core.get_objc_msgSendSuper(msgtypes)) 
                            : ( structRaw ? core.get_objc_msgSend_stret(msgtypes) 
    ...
    try {
      ...
      if(!structRaw) return core.wrapValue(unwrappedVals, msgtypes[0]);
