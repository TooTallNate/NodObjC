module.exports = (function() { 
  ...
  Class.wrap = function(pointer, className) {
    ...
    var rtn = function() {
      ...
      return newClass.msgSend(sel,args);
    };
  ...
  /**
   * TODO: Write me a header!
   */
  Class.prototype.msgSendHelper = function(msgtypes,sel,args) {
  ...
  Class.prototype.msgSendSuperHelper = function(msgtypes, sel, args) {
    var os = new objc_super;
    os.receiver = this.pointer;
    os.class = this.getSuperclass().pointer;
  ...
  Class.prototype.msgSendSuperStructHelper = function(structRaw,msgtypes,sel,args) {
    var os = new objc_super;
    os.receiver = this.pointer;
    os.class = this.getSuperclass().pointer;
  ...
  Class.prototype.msgSendStructHelper = function(structRaw,msgtypes,sel,args) {
    var structNew = new structRaw();
    var structType = msgtypes[0];
  ...
  Class.prototype.msgSendSuper = function(sel, args) {
   ...
   * if necessary.
   */
  Class.prototype.msgSend = function(sel, args) {
    var msgtypes = this.getTypes(sel, args);
    var structRaw;
