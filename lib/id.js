...
ID.prototype.isClass = false;
ID.prototype.type = '@';

ID.prototype[invoke] = function () {
  return this.msgSend(arguments, false);
};
...
ID.prototype.getTypes = function(sel, args) {
  ...
  if (this.isClass) {
    method = this.getClassMethod(sel);
  } else {
    method = this.getClass().getInstanceMethod(sel);
  }
